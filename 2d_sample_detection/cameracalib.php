			...
			<div class="text-container">
				...
				if ($lang == 'ro'):
					...
					<div class="stext" ><b class="bc" >1.</b> Creează un script python cu numele <u >camera_calibration.py</u>
																				...
																				<div class="rtext" ><img src="/assets/ai/straight_sample.png" style="border-radius: 10px; width: 37.5vh" loading="lazy" ></div>
																				<div class="rtext" >
																				...
																				<div class="rtext" ><b class="bc" >3.</b> Acum trebuie rotit sample-ul la unghiul de 90 de grade, iar mai
																					...
																					în imagine</div>
																				<div class="rtext" >Exemplu: </div>
																				<div class="rtext" ><img src="/assets/ai/90_degree.png" style="border-radius: 10px; width: 37.5vh" loading="lazy" >
																				</div>
																				<div class="rtext" >
																				...
																				<div class="rtext" ><b class="bc" >1.</b> După ce minWidth, minHeight, maxWidth, maxHeight au fost
																					...
																					<div class="rtext" >
																						<li >Unghiul dat de <b class="bc" >arctg</b> atunci când sample-ul este la unghiul de <b class="bc" >90 de grade</b> este de <b class="bc" >66.32 de grade</b></li>
																					</div>
																				</div>
																				<div class="rtext" >&nbsp;</div>
																				<div class="rtext" ><b class="bc" >2.</b> După aflarea unghiului atunci când sample-ul este drept și la 90
																					...
																					<div class="rtext" >
																						<li >Formula matematică finală: <b class="bc" >[arctg(object_width/object_height)-24.79]/0.45955</b></li>
																					</div>
																				</div>
																				<div class="rtext" >&nbsp;</div>
																				<div class="stext" ><b class="bc" >3. </b>Calcularea poziției Intake-ului bazat pe unghiul sample-ului (<b class="bc" >Servo Intake</b>)</div>
																				<div class="rtext" >
																				...
																				<div class="stext" ><b class="bc" >După ce ai terminat calibrarea camerei, întoarce-te înapoi la <u ><a href="/model/intothedeep/prerequisites" style="text-decoration: none; color: white" >Getting
																								Started</a></u></b></div>
																				<div class="endLine" ></div>
																				<div class="endD" ><a href="https://discord.gg/ZB6vQ62KZT" >Support -&gt; Discord</a></div>
																				<div class="end" ></div>
<?php else: ?>
					<div class="stext" ><b class="bc" >1.</b> Create a python script named <u >camera_calibration.py</u></div>
					
					<div class="stext" ><div class="codee-window" >
																						<pre ><code class="language-python" >import cv2
																						from ultralytics import YOLO
																						import math
					...
					<div class="rtext" ><b class="bc" >2.</b> Make sure the sample is <b class="bc" >completely</b>
																					in the image. It is essential that the sample fits in the image and is not half out of the image</div>
					
					<div class="rtext" >Example:</div>
					
					<div class="rtext" ><img src="/assets/ai/straight_sample.png" style="border-radius: 10px; width: 37.5vh" loading="lazy" ></div>
					
					<div class="rtext" ><li >From here, note <u >minWidth</u> which is equal to <b class="bc" >Width</b> and
					...
					<div class="rtext" ><b class="bc" >3.</b> Now rotate the sample to a 90-degree angle, and then note
																					<u >maxWidth</u>, <u >maxWidth</u>. Make sure the sample is completely in the image</div>
					
					<div class="rtext" >Example:</div>
					
					<div class="rtext" ><img src="/assets/ai/90_degree.png" style="border-radius: 10px; width: 37.5vh" loading="lazy" ></div>
					
					<div class="rtext" ><li >From here, note maxWidth which is equal to Width and maxWidth which is equal to Height
																					</li></div>
					...
					<div class="rtext" ><b class="bc" >2.</b> After finding the angle when the sample is straight and at 90
																					...
																					<div class="rtext" >
																						<li >Final mathematical formula: <b class="bc" >[arctg(object_width/object_height)-24.79]/0.45955</b></li>
																					</div></div>
					
					<div class="rtext" >&nbsp;</div>
					
					<div class="stext" ><b class="bc" >3. </b>Calculating the Intake position based on the sample angle (<b class="bc" >Servo Intake</b>)</div>
					
					<div class="rtext" ><li >Let's take the example that the Intake at position 0.5 is perfectly straight and can only take
																						samples in a straight position</li></div>
					
					<div class="rtext" ><li >The Intake position must be measured when it is 90 degrees to the left and similarly when it is
																						90 degrees to the right</li></div>
					
					<div class="rtext" ><li >Position 0.15 is the 90-degree angle to the left of the Intake.</li></div>
					
					<div class="rtext" ><li >Position 0.85 is the 90-degree angle to the right of the Intake.</li></div>
					
					<div class="rtext" ><li >Thus we know that 0.85-0.5 = 0.35 has a rotation of 90 degrees. So we divide 0.35 by 90 degrees
																					</li></div>
					
					<div class="rtext" ><li >0.35/90 degrees = 0.0038 Intake position/degree. So for every 0.0038 added to the Intake
																						position, the Intake moves 1 degree to the right</li></div>
					
					<div class="rtext" ><li >This formula can also be applied to other Intakes with different servo positions.</li></div>
					
					<div class="stext" ><b class="bc" >After you have finished calibrating the camera, go back too <u ><a href="/model/intothedeep/prerequisites" style="text-decoration: none; color: white" >Getting
																								Started</a></u></b></div>
